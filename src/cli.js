...
Usage:
  ...
  dato contentful-import --datoCmsToken=<apiToken> [--datoCmsEnvironment=<datoEnvironment>] --contentfulToken=<apiToken> --contentfulSpaceId=<spaceId> [--skipContent] [(--includeOnly <contentType>...)]
  dato check
  dato -h | --help
  dato --version
